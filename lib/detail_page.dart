...
class _DetailProdukPageState extends State<DetailProdukPage> {
  ...
  Future<void> fetchProductDetail() async {
    ...
    try {
      final response = await http.get(
        Uri.parse('http://192.168.100.110:3006/product/${widget.productId}?format=json'),
      );
  ...
  // Fungsi untuk mendapatkan gambar produk berdasarkan ID produk
  ImageProvider getProductImage(int productId) {
    switch (productId) {
      case 1:
      ...
      default:
        return AssetImage('assets/produk1.jpg');
    }
  }
